                ...
                >
                    <div>
                        <Stack gap={3}>
                            ...
                            <div className="app-information-description">
                                At ServiceHub, we connect you with skilled
                                professionals offering a wide range of services,
                                from plumbing and carpentry to many more. Browse
                                through our listings, view profiles, and hire
                                the right expert at a fair wage. Your perfect
                                service provider is just a click away!
                            </div>
                        </Stack>
                    </div>
                    ...
                    <div>
                        <Stack gap={3}>
                            ...
                            <Button className="colored-primary">
                                Register
                            </Button>
                        </Stack>
                    </div>
